!!
!! REJECTS VALID /ICE / INCORRECT RESULTS
!!
!! The ifx 2025.1 compiler rejects the test1 code, segfaults on test2,
!! and compiles test3 without error, but produces incorrect results.
!!
